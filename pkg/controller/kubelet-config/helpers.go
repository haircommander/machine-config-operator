...
// wrapErrorWithCondition converts an error into a KubeletConfigCondition with type KubeletConfigAccepted.
...
// TODO(OCPNODE-4040): Remove once openshift/origin and openshift/oc use KubeletConfigAccepted.
